...
<tr><td class="lefttd">Mobile No</td><td>: <input type="text" class="text-input" name="mobile" required="required" pattern="[0-9]{10,11}" title="please enter only numbers between 10 to 11 for mobile no." /></td></tr>
                        ...
                        <tr><td class="lefttd" >County</td><td>
                                : <select name="county" class="text-input" required>
                                    ...
                                    <option class="text-xs-center" value="Kisii">Kisii</option>
                                    <option class="text-xs-center" value="Kisumu">Kisumu</option>
                                    <option class="text-xs-center" value="Homa Bay">Homa Bay</option>
                                    <option class="text-xs-center" value="Siaya">Siaya</option>
                                    <option class="text-xs-center" value="Migori">Migori</option>
                                </select>
<tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
